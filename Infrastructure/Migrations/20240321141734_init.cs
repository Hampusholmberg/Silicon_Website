        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressLine2 = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseAuthorImages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YoutubeFollowersQty = table.Column<int>(type: "int", nullable: false),
                    FacebookFollowersQty = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseAuthors_CourseAuthorImages_ImageId",
                        column: x => x.ImageId,
                        principalTable: "CourseAuthorImages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProfiles_ProfilePictures_ProfilePictureId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LikesAmount = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Courses_CourseImages_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserProfileEntityId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedCourses", x => new { x.CourseId, x.UserProfileId });
                    table.ForeignKey(
                        name: "FK_SavedCourses_UserProfiles_UserProfileEntityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_AddressLine1_AddressLine2_PostalCode_City",
                table: "Addresses",
                columns: new[] { "AddressLine1", "AddressLine2", "PostalCode", "City" },
                unique: true,
                filter: "[AddressLine1] IS NOT NULL AND [AddressLine2] IS NOT NULL AND [PostalCode] IS NOT NULL AND [City] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedCourses_UserProfileEntityId",
                table: "SavedCourses",
