        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YoutubeFollowersQty = table.Column<int>(type: "int", nullable: true),
                    FacebookFollowersQty = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LikesPercentage = table.Column<int>(type: "int", nullable: true),
                    LikesAmount = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSavedItems", x => new { x.UserId, x.CourseId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSavedItems_UserProfiles_UserId1",
                        column: x => x.UserId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSavedItems_UserId1",
                table: "UserSavedItems",
                column: "UserId1");
        }
